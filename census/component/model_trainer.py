...
from census.entity.entity_config import ModelTrainerConfig
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            census_model = CensusEstimatorModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
